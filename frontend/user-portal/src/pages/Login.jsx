    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800">Sign in to Miles&Smiles</h1>
          <p className="text-gray-500 mt-2">Access your account and manage bookings</p>
        </div>
        ...
        <div className="card">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/register" className="text-turkish-red font-semibold hover:underline">
                Join Miles&Smiles
              </Link>
            </p>
          </div>
